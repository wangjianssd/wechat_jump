...
def jump(distance):
    ...
    press_time = press_time * 0.7

    press_time = max(press_time, 200)   # 设置 200ms 是最小的按压时间
    press_time = int(press_time)

    if current_score > finnal_score:
        print("finnal_score:" + str(finnal_score) + "  current_score:" + str(current_score))
        print('-------------------------------------------------------------------------')
        press_time += 3000
    ...
    if current_score > target_score:
        press_time += 3000
        print("target_score:" + str(target_score) + "  current_score:" + str(current_score))
        print('-------------------------------------------------------------------------')
        target_score += 76
